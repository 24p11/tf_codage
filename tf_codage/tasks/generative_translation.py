...
class GenerativeTranslationTrainer:
    ...
    def build(self):
        ...
        self.train_ds = md.get_data("generative_tranformer_train_preprocessing")

        md.DATASET_NAME = "val"
        self.val_ds = md.get_data("generative_tranformer_train_preprocessing")

        md.DATASET_NAME = "test"
        md.DATASET_EPOCHS = 1
        self.test_ds = md.get_data("generative_tranformer_eval_preprocessing")
